        ...
        <ul className="hidden md:flex gap-6 text-xs uppercase items-center">
            ...
            >
              ...
              <MdArrowDropDown
                className={`text-base transition-transform duration-300 ${
                  dropdownState.isDropdownOpen ? "rotate-180 text-[#ff4141]" : ""
                }`}
              />
            </span>
            <ul
          ...
          <div className="relative flex items-center gap-4">
            {!user ? (
              ...
              <>
      <div
        className="w-8 h-8 flex items-center justify-center bg-[#ff4141] text-white rounded-full text-sm font-semibold cursor-pointer transition-transform hover:scale-110"
...
<div
  className={`fixed inset-0 bg-black/50 transition-opacity duration-300 ${
    dropdownState.isMobileMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
  }`}
