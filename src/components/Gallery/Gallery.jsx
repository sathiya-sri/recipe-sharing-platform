...
const Gallery = () => {
  ...
  <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4">
    <motion.div
      className="relative w-[90%] max-w-[500px] h-auto flex flex-col items-center justify-center bg-white rounded-md shadow-md p-4"
    ...
    >
      ...
      {currentIndex > 0 && (
        <button
          className="absolute left-5 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full text-black text-lg md:text-2xl"
          onClick={prevImage}
        >
          <AiOutlineLeft />
        </button>
      ...
      {currentIndex < images.length - 1 && (
        <button
          className="absolute right-5 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full text-black text-lg md:text-2xl"
          onClick={nextImage}
        >
          <AiOutlineRight />
        </button>
