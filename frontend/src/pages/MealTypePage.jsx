...
const MealTypePage = () => {
    ...
    const typingText = "Discover the perfect meal type for every craving!";
  ...
  return (
    <div className="px-6 md:px-12 py-12 min-h-screen" >
      ...
      >
        ...
        <motion.h1 className="relative text-white text-xl md:text-3xl font-medium uppercase tracking-wide flex-wrap z-10 flex p-2">
          ...
          {/* Blinking Cursor */}
          <motion.span
            className="ml-1 w-[6px] h-[30px] md:h-[36px] bg-white inline-block"
      ...
      <CategorySlider CategoryData={MealTypeData} filterType="mealType" />
